...
$cuisineQuery = "SELECT DISTINCT cuisine_type FROM cuisine_items";
...
if (!empty($searchCuisine)) {
    $sql .= " AND cuisine_type = '$searchCuisine'";
}
...
<body>
    ...
    <div class="search-container">
        <form method="GET" action="view_all_menu.php">
        ...
        <div class="search-results">
            ...
            if ($result->num_rows > 0) {
                while ($meals = mysqli_fetch_assoc($result)) {
                    echo '<div class="search-item" data-cuisine="' . htmlspecialchars($meals['name']) . '">';
                    echo '<a href="view_menu_items.php?cuisine_item=' . urlencode($meals['id']) . '">';
    ...
    <div class="menu-container">
        ...
        <div class="cuisine-grid">
            <?php
            // Reset result pointer and display all menu items
            mysqli_data_seek($result, 0);
            while ($meals = mysqli_fetch_assoc($result)): ?>
                <div class="cuisine-item">
                    <a href="view_menu_items.php?cuisine_item=<?php echo urlencode($meals['id']); ?>">
